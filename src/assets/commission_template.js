`<div class="pagebreak" style="page-break-before: always;">
    ...
    <table class="fr-dashed-borders fr-alternate-rows" style="width: 100%;">
        <tbody>
            ...
            <tr>
                <td colspan="2" style="width: 49.1309%;"><strong>Agent Name</strong>:{$80501761 Agent Name}<br></td>
                <td colspan="2" style="width: 49.7103%;"><strong>Date</strong>:{$80501762 Date}<br></td>
            </tr>
            <tr>
                <td><br></td>
                <td><br></td>
            ...
            <tr>
                <td colspan="2" style="width: 51.1008%;"><strong>Client Names</strong>: {tenant}<br></td>
